...
import { Package, Wine, ShoppingCart, Trash2, TrendingUp, ArrowDownToLine, ArrowUpFromLine } from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="bg-card border-border shadow-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Wasting Hari Ini</CardTitle>
              <Trash2 className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-foreground font-mono">{dashboard.totalWastingToday.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground mt-1">Total kerugian wasting</p>
            </CardContent>
          </Card>
        </div>
      </div>
